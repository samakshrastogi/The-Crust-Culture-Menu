const MENU_DATA = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Butter Masala", prices: ["69"] },
      { name: "Creamy", prices: ["69"] },
      { name: "Masala Magic", prices: ["69"] },
      { name: "Pudina Masala", prices: ["69"] },
      { name: "Achari", prices: ["69"] },
      { name: "Garlic Masala", prices: ["69"] },
      { name: "Lemon Pepper", prices: ["69"] },
      { name: "Tangy Tomato", prices: ["69"] },
      { name: "Mexican Masala", prices: ["69"] },
      { name: "Curry Corn", prices: ["69"] },
      { name: "Chilli Garlic", prices: ["69"] },
      { name: "Mumbai Masala", prices: ["69"] },
      { name: "Italian Herb", prices: ["69"] },
      { name: "Pizza Corn", prices: ["69"] },
      { name: "BBQ Corn", prices: ["69"] },
      { name: "Smoky BBQ", prices: ["69"] },
      { name: "Korean Spicy Corn", prices: ["69"] },
      { name: "Thai Chilli Corn", prices: ["69"] },

      { name: "Cheese", prices: ["99"] },
      { name: "Cheese Garlic Corn", prices: ["99"] },
      { name: "Cheesy Jalapeno Corn", prices: ["99"] },
      { name: "Cheese Peri Peri Corn", prices: ["99"] },
      { name: "White Sauce Corn", prices: ["99"] },
      { name: "Mayo Corn", prices: ["99"] },
      { name: "Cheese Burst Corn", prices: ["99"] },
      { name: "Creamy Herb Corn", prices: ["99"] },

      { name: "Loaded Cheese Corn", prices: ["119"] },
      { name: "Mexican Cheese Corn", prices: ["119"] },
      { name: "Truffle Corn", prices: ["119"] },
      { name: "Triple Cheese Corn", prices: ["119"] },
    ],
},
  {
